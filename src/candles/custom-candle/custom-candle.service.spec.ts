...
describe('CustomCandleService', () => {
  ...
  describe('findAll', () => {
    it('should return all custom candles', async () => {
      ...
      expect(customCandleRepository.find).toHaveBeenCalledWith({ relations: ['user', 'container', 'fragrance', 'emotionalState'] });
    });
  });
  ...
  describe('findOne', () => {
    it('should return a custom candle by ID', async () => {
      ...
      expect(customCandleRepository.findOne).toHaveBeenCalledWith({
        ...
        relations: ['user', 'container', 'fragrance', 'emotionalState'],
      });
    });
